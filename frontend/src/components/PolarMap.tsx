...
export function parsePolarLocation(location: string | null): [number, number] | null {
...
export type PolarMarker = { id: string; location: string | null; label: string; detail?: string; color: string };
